...
export class DocumentOverlayPreviewService {
  ...
  async build(
    ...
    switch (documentId) {
      ...
      case 'airdraft':
        return this.airdraftPdf.build(data);
      case 'shipStores':
  ...
  private appData(): AppData {
    return {
      ...
      phoneLibrary: this.storage.phoneLibrary(),
      depRepLibrary: this.storage.depRepLibrary(),
      appSnapshots: this.storage.appSnapshots(),
      dgPageArchives: this.storage.dgPageArchives(),
      reeferPageArchives: this.storage.reeferPageArchives(),
