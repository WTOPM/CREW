...
export function crewListV2PdfFileName(
  shipName: string,
  portOfCall: string,
  voyageDate: string,
  isArrival: boolean,
  ...
  const kind = isArrival ? 'Arrival' : 'Departure';
  return `Crew_List_V2_${kind}_${pdfFileToken(shipName, 'ship')}_${pdfFileToken(portOfCall, 'port')}_${pdfFileDate(voyageDate)}.pdf`;
}

export function crewListV3SbkPdfFileName(
  shipName: string,
  portOfCall: string,
  voyageDate: string,
  isArrival: boolean,
  ...
  const kind = isArrival ? 'Arrival' : 'Departure';
  return `Crew_List_V3_SBK_${kind}_${pdfFileToken(shipName, 'ship')}_${pdfFileToken(portOfCall, 'port')}_${pdfFileDate(voyageDate)}.pdf`;
}

export function crewListForm05PdfFileName(
  shipName: string,
  portOfCall: string,
  voyageDate: string,
  isArrival: boolean,
  ...
  const kind = isArrival ? 'Arrival' : 'Departure';
  return `Crew_List_Form_05_${kind}_${pdfFileToken(shipName, 'ship')}_${pdfFileToken(portOfCall, 'port')}_${pdfFileDate(voyageDate)}.pdf`;
}

export function crewListV3SbkPPdfFileName(
  shipName: string,
  portOfCall: string,
  voyageDate: string,
  isArrival: boolean,
