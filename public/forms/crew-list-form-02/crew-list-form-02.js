const tbody = document.getElementById('tbody');
    ...
    function rebuildListForMode(mode) {
      ...
      const savedVar = window._appData.documentOverlay?.crewList?.byType?.[CREW_FORM_02_TYPE];
