const MAX_ROWS = 18; // keep in sync with CREW_LIST_FORM_06_MAX_ROWS in crew-list-form-06.paths.ts
    const DEMO = [
      { name: 'PETROV Ivan Sergeyevich', rank: 'Master', nat: 'RUS', birth: '15.03.1975 Moscow', bno: 'RUS12345678', bplace: 'MOSCOW', bexp: '10.08.2027', passport: '751234567', joinPort: 'GENOA', joinDate: '01.05.2025' },
      { name: 'KIM Jong-su', rank: 'Chief Officer', nat: 'KOR', birth: '22.07.1980 Busan', bno: 'KOR98765432', bplace: 'BUSAN', bexp: '15.03.2026', passport: 'M12345678', joinPort: 'SINGAPORE', joinDate: '15.04.2025' },
    ];
    ...
    function navigateBack(feedback) {
      ...
      if (feedback) {
        ...
        target += `${sep}form06Feedback=${feedback}`;
      }
    ...
    function loadPositions() {
      ...
      try {
        ...
        if (appData && appData.documentOverlay && appData.documentOverlay.crewList && appData.documentOverlay.crewList.byType) {
          const variant = appData.documentOverlay.crewList.byType[CREW_FORM_06_TYPE];
          if (variant) {
    ...
    async function persistAllChanges() {
      ...
      if (!appData.documentOverlay.crewList) {
        appData.documentOverlay.crewList = { listType: CREW_FORM_06_TYPE, byType: {} };
      }
