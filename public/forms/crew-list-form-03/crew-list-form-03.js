const DEMO = [
      { name: 'PETROV Ivan Sergeyevich', rank: 'Master', nat: 'RUS', birth: '15.03.1975 Moscow', doc1: 'RUS12345678', doc2: 'SBK-001', joinDate: '01.01.2024', joinPlace: 'Rotterdam', temperature: '' },
      { name: 'KIM Jong-su', rank: 'Chief Officer', nat: 'KOR', birth: '22.07.1980 Busan', doc1: 'KOR98765432', doc2: 'SBK-002', joinDate: '05.02.2024', joinPlace: 'Singapore', temperature: '' },
    ];
    const MAX_ROWS = 15;
    ...
    <div class="td-cell ch-name"><input class="ci" type="text" value="${escAttr(d.name)}" readonly tabindex="-1"></div>
    ...
    function resetCellStyles() {
      tableBody.querySelectorAll('input.ci').forEach((input) => {
